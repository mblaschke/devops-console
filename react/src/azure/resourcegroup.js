                    ...
                    <div className="card-body">
                        <form method="post">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" name="nsApp" id="inputRg" className="form-control"
                                       placeholder="ResourceGroup name" required value={this.getValue("form.name")}
                                       onChange={this.setValue.bind(this, "form.name")}/>
                            </div>
                            <div className="form-group">
                                <label htmlFor="inputRgLocation" className="inputRgLocation">Azure Location</label>
                                <input type="text" name="nsApp" id="inputRgLocation" className="form-control"
                                       placeholder="ResourceGroup location" required
                            ...
                            {this.azureResourceGroupTagConfig().map((setting) =>
                                <div className="form-group">
                                    ...
                                    <input type="text" name={setting.name} id={setting.name} className="form-control"
                                           placeholder={setting.placeholder}
                                           value={this.getValue("form.tags." + setting.name)}
                                           onChange={this.setValue.bind(this, "form.tags." + setting.name)}/>
                                    <small className="form-text text-muted">{setting.description}</small>
                                </div>
                            )}
                            <div className="toolbox">
                                <button type="submit" className="btn btn-primary bnt-azure-resourcegroup-create"
                                        disabled={this.stateCreateButton()}
                                        onClick={this.createResourceGroup.bind(this)}>{this.state.buttonText}</button>
                                <button type="button" className="btn btn-secondary bnt-azure-resourcegroup-open"
                                        disabled={this.stateOpenButton()}
                                        onClick={this.openResourceGroup.bind(this)}>Goto ResourceGroup
                                </button>
                            </div>
                        </form>
                    </div>
